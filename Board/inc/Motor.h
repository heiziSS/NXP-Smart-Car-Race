...
#define         L_GO_CH      FTM_CH0
//左电机后退的FTM通道
#define         L_BACK_FTM      FTM0
#define         L_BACK_CH       FTM_CH1
//右电机前进的FTM通道
#define         R_GO_FTM     FTM0
#define         R_GO_CH      FTM_CH2
//右电机后退的FTM通道
...
#define LEFT_ENCODER_COUNT        PTB19           //定义左编码器的DMA计数引脚
#define LEFT_ENCODER_DIRECTION    PTB18           //定义左编码器的DMA采集正负引脚
#define RIGHT_ENCODER_DMA_CH      DMA_CH2         //定义右编码器的DMA采集通道
#define RIGHT_ENCODER_COUNT       PTE1            //定义右编码器的DMA计数引脚
#define RIGHT_ENCODER_DIRECTION   PTE0            //定义右编码器的DMA采集正负引脚
